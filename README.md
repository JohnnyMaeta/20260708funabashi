...
| :---- | :---------------------- | :------------------------------------------------------------------------------------------------------- |
| 14:30～14:35 | **開会・趣旨説明** | |
| 14:35～16:20 | **講義・実践研修** | **[前半] 指導案・評価の爆速作成**<br>・NotebookLM × Gemini 連携<br>・指導要領PDFの読み込みと授業プラン生成<br>・評価基準（ルーブリック）作成・Googleフォーム変換<br><br>**[後半] 子供の伴走AI（Gem）作成**<br>・前半の指導案をAI指示文に活用<br>・「言葉」で導くコーチング設計<br>・A表現(1)イ（デザイン）を題材とした体験 |
| 16:20～16:30 | **質疑応答** | |
